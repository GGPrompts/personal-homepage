...
const allEngines: SearchEngine[] = [
  ...
  },
  {
    ...
    shortcut: "bi",
    icon: ImagePlus,
    urlTemplate: "https://www.bing.com/images/create?q={query}",
  ...
  },
  {
    ...
    shortcut: "ideo",
    icon: Palette,
    urlTemplate: "https://ideogram.ai/t/explore?q={query}",
    placeholder: "Describe an image...",
    color: "text-purple-400",
    category: "image",
  },
  {
    ...
    shortcut: "leo",
    icon: Wand2,
    urlTemplate: "https://app.leonardo.ai/ai-generations?prompt={query}",
    placeholder: "Describe an image...",
    color: "text-amber-400",
    category: "image",
  },
  {
    ...
    shortcut: "ta",
    icon: Brush,
    urlTemplate: "https://tensor.art/search?q={query}&type=models",
  ...
  },
  {
    ...
    shortcut: "pg",
    icon: Camera,
    urlTemplate: "https://playground.com/create?prompt={query}",
    placeholder: "Describe an image...",
    color: "text-emerald-400",
    category: "image",
  },
  {
    ...
    shortcut: "lex",
    icon: Image,
    urlTemplate: "https://lexica.art/?q={query}",
